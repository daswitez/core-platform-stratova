...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiErrorResponse> handleSolverException(
        ...
        log.error("event=IAM_API_EXCEPTION_HANDLED errorCode={} status={} path={}", 
                ex.getCode(), status.value(), request.getRequestURI(), ex);
    ...
    public ResponseEntity<ApiErrorResponse> handleIamServiceException(
            IamServiceException ex,
            HttpServletRequest request
    ) {
        log.error("event=IAM_API_EXCEPTION_HANDLED errorCode={} status={} path={}", 
                ex.getErrorCode(), HttpStatus.INTERNAL_SERVER_ERROR.value(), request.getRequestURI(), ex);
    ...
    public ResponseEntity<ApiErrorResponse> handleMethodArgumentNotValidException(
        ...
        log.warn("event=IAM_API_EXCEPTION_HANDLED errorCode={} status={} path={}", 
                ErrorCodes.VALIDATION_ERROR, HttpStatus.BAD_REQUEST.value(), request.getRequestURI(), ex);
    ...
    public ResponseEntity<ApiErrorResponse> handleException(
        ...
        log.error("event=IAM_API_EXCEPTION_HANDLED errorCode={} status={} path={}", 
                ErrorCodes.UNEXPECTED_ERROR, HttpStatus.INTERNAL_SERVER_ERROR.value(), request.getRequestURI(), ex);

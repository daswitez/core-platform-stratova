...
public class GlobalRestExceptionHandler {
    ...
    private ResponseEntity<ErrorResponse> handleSolverException(
        ...
        log.error("event=IAM_ERROR errorCode={} status={} path={}", 
    ...
    public ResponseEntity<ErrorResponse> handleIamServiceException(
        ...
        log.error("event=IAM_SERVICE_ERROR errorCode={} path={}", 
                ex.getErrorCode(), request.getRequestURI(), ex);
    ...
    public ResponseEntity<ErrorResponse> handleGenericException(
        ...
        log.error("event=IAM_UNEXPECTED_ERROR errorCode={} path={}", 
                DEFAULT_ERROR_CODE, request.getRequestURI(), ex);
